...
class Clientes extends CI_Controller {
    ...
    public function edit($cliente_id = NULL) {
        if (!$cliente_id || !$this->core_model->get_by_id('clientes', array('cliente_id' => $cliente_id))) {
            ...
            [cliente_tipo] => 2
            [cliente_nome] => Inocêncio
            [cliente_sobrenome] => Cordeiro
            [cliente_data_nascimento] => 1999-03-30
            [cliente_cpf_cnpj] => 50.389.234/0001-40
            [cliente_rg_ie] => 
            [cliente_email] => 
            [cliente_telefone] => 
            [cliente_celular] => 
         ...
         //   if($cliente_tipo == 1) {
         //       $this->form_validation->set_rules('cliente_cpf_cnpj', '', 'trim|required|exact_length[18]callback_valida_cpf');

        //    }else{
         //       $this->form_validation->set_rules('cliente_cpf_cnpj', '', 'trim|required|exact_length[18]callback_valida_cnpj');
         //   }
