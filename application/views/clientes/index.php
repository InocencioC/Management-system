...
<?php endif; ?>
        ...
        <a title="Cadastrar novo cliente" href="<?php echo base_url('cliente/add'); ?>" class="btn btn-success btn-sm float-right"><i class="fas fa-user-tie"></i>&nbsp;Novo</a>
          </div>
            <div class="card-body">
                ...
                <table class="table table-bordered dataTable"  width="100%" cellspacing="0">
                  <thead>
                    <tr>
                      ...
                      <th class="text-right no-sort pr-2">Acções</th>
                    </tr>
                  </thead>      
                  <tbody>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <a class="btn btn-danger btn-sm" href="<?php echo base_url('clientess/del/'.$cliente->cliente_id); ?>">Sim</a>
        </div>
      </div>
    </div>
  </div> 
