...
<div class="card shadow mb-3">
  ...
  <div class="col-md-3">
    ...
    <input type="text" class="form-control form-control-user" name="sistema_cnpj" placeholder="S" value="<?php echo $sistema->sistema_cnpj;  ?>" >
  ...
  <div class="col-md-3">
    ...
    <input type="text" class="form-control form-control-user" name="sistema_email" placeholder="E-mail de contacto" value="<?php echo $sistema->sistema_email;  ?>" >
...
<div class="col-md-2">
<label>Estado</label>
<input type="text" class="form-control form-control-user" name="sistema_estado" placeholder="Estado" value="<?php echo $sistema->sistema_estado;  ?>" >
